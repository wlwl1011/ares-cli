...
Generator.prototype.generate = function(options, next) {
    ...
    /*
        ...
        webappinfo: {
            type: 'webappinfo',
            path: '/usr/lib/node_modules/@webosose/ares-cli/files/templates/ose-sdk-templates/appinfo/appinfo.json',
            description: 'appinfo.json for web app'
        },
        js_service: {
            type: 'jsservice',
            path: '/usr/lib/node_modules/@webosose/ares-cli/files/templates/ose-sdk-templates/js-service',
            description: 'js service for webOS',
            metadata: { id: 'jsserviceinfo' }
        },
        jsserviceinfo: {
            type: 'jsserviceinfo',
            path: [
            '/usr/lib/node_modules/@webosose/ares-cli/files/templates/ose-sdk-templates/serviceinfo/services.json',
            '/usr/lib/node_modules/@webosose/ares-cli/files/templates/ose-sdk-templates/serviceinfo/package.json'
            ],
            description: 'services.json, package.json for JS service'
        },
        icon: {
            type: 'icon',
            path: '/usr/lib/node_modules/@webosose/ares-cli/files/templates/ose-sdk-templates/icon',
            description: 'app icon files [80x80]'
        },
        qmlapp: {
            type: 'qmlapp',
            path: '/usr/lib/node_modules/@webosose/ares-cli/files/templates/ose-sdk-templates/qml-app',
            description: 'QML app for webOS',
            metadata: { id: 'qmlappinfo' },
            deps: [ 'icon' ]
        },
        qmlappinfo: {
            type: 'qmlappinfo',
            path: '/usr/lib/node_modules/@webosose/ares-cli/files/templates/ose-sdk-templates/qmlappinfo/appinfo.json',
    ...
    return promise.resolve()
        .then(function() {
            ...
            if  (tmplName.match(/(^src)/)){
                ...
                /// now pwd acp_service/src .... we have to move one more
                template.path = template.path + "/src";
                ...
                return promise.all(srcs.map(function(src) {
                    ...
                    if (metaTmpl) {
                        if (appinfo.url) {
                            url = appinfo.url;
                            delete appinfo.url;
                            const urlTmpl = {"path":path.join(srcs[0],'main.c')};
